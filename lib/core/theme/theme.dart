...
class MaterialTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      tertiary: Color(0xff186584),
      onTertiary: Color(0xffffffff),
      tertiaryContainer: Color(0xffc1e8ff),
      onTertiaryContainer: Color(0xff004d67),
      ...
      tertiaryFixed: Color(0xffc1e8ff),
      onTertiaryFixed: Color(0xff001e2b),
      tertiaryFixedDim: Color(0xff8dcff2),
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      ...
      tertiary: Color(0xff003b50),
      onTertiary: Color(0xffffffff),
      tertiaryContainer: Color(0xff2d7494),
      ...
      tertiaryFixed: Color(0xff2d7494),
      onTertiaryFixed: Color(0xffffffff),
      tertiaryFixedDim: Color(0xff015c7a),
  ...
  static ColorScheme lightHighContrastScheme() {
    return const ColorScheme(
      ...
      onSecondaryFixedVariant: Color(0xffffffff),
      tertiaryFixed: Color(0xff004f6a),
      onTertiaryFixed: Color(0xffffffff),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      ...
      tertiaryContainer: Color(0xff89cbee),
